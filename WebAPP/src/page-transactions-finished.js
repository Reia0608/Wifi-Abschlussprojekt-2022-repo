...
export default class PageTransactionFinished
{
	constructor(args) 
	{
        this.app = args.app;
		args.app.LoadHTML('./page-transactions-finished.html', args.app.Main, () => 
		{
	...
	datenLaden()
	{
		this.app.ApiBewegungGetFinishedList((response) => 
		{
			let html = '';
			let iterator = 1;
			let benutzerList = "";
