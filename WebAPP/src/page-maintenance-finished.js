...
export default class PageMaintenanceFinished
{
	constructor(args) 
	{
        this.app = args.app;
		args.app.LoadHTML('./page-maintenance-finished.html', args.app.Main, () => 
		{
	...
	datenLaden()
	{
		this.app.ApiWartungsterminGetFinishedList((response) => 
		{
