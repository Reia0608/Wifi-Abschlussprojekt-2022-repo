...
export default class PageTerminStart
{
	constructor(args) 
	{
		this.app = args.app;
		...
		args.app.LoadHTML('./page-termin-start.html', args.app.Main, () => 
	    {
            ...
            {
                if(inputKmStart.value)
                {
                    if (confirm('Wollen Sie den Termin starten?')) 
                    {
                        if(args.bid)
                        {
                            this.app.ApiRentObjectGet((response) =>
                            {
                                if(response)
                                {
                                    ...
                                    this.rentObject.start_km_stand = inputKmStart.value;
                                    this.rentObject.zeit_start = new Date().toISOString();
                ...
                {
                    alert("Bitte zunächst den Anfangskilometerstand ausfüllen!");
                }              
            });
		}); // LoadHTML
	} // constructor
