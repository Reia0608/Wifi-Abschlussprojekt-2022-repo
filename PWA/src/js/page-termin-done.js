...
export default class PageTerminDone
{
                        ...
                        this.app.ApiRentObjectGet((response) =>
                        {
                            if(response)
                            {
                                ...
                                this.app.ApiRentObjectSet(() =>
                                {
                                    ...
                                    window.open('#terminrunning?bid=' + this.rentObject.bewegung_id, '_self');
                                }, (ex) =>
                                {
                                    alert(ex);
                                }, this.rentObject);
    ...
    datenLaden(bewegung_id) 
	{
		...
		this.app.ApiRentObjectGet((response) => 
		{
            ...
            // WIP: this actually should go into the button click part of page-termin-running.js to update the database!
            divZuZahlen.innerHTML = this.Helper.KmPriceCalculator(this.bewegung.preis_kfz, this.bewegung.preis_schutzpaket, this.bewegung.preis_anhaenger, this.bewegung.preis_fahrer, preisSchaden, this.bewegung.start_km_stand, this.bewegung.ende_km_stand);
